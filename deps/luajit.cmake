...
if ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_X64 1")
  set(TARGET_LJARCH x64)
elseif ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_X86 1")
  set(TARGET_LJARCH x86)
elseif ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_ARM 1")
  set(TARGET_LJARCH arm)
elseif ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_ARM64 1")
  set(TARGET_LJARCH arm64)
  if ("${TARGET_TESTARCH}" MATCHES "__AARCH64EB__")
    SET(TARGET_ARCH "-D__AARCH64EB__=1")
  endif()
elseif ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_PPC 1")
...
elseif ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_PPCSPE 1")
  set(TARGET_LJARCH ppcspe)
elseif ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_MIPS 1")
  if ("${TARGET_TESTARCH}" MATCHES "MIPSEL")
    set(TARGET_ARCH "-D__MIPSEL__=1")
  endif ()
  if ("${TARGET_TESTARCH}" MATCHES "LJ_TARGET_MIPS64 1")
...
ENDIF()
string(REGEX MATCH "LJ_ARCH_VERSION [0-9]+" LJ_ARCH_VERSION ${TARGET_TESTARCH})
if(LJ_ARCH_VERSION)
string(REGEX MATCH "[0-9]+" LJ_ARCH_VERSION ${LJ_ARCH_VERSION})
endif()
if(LJ_ARCH_VERSION)
SET(DASM_FLAGS ${DASM_FLAGS} -D VER=${LJ_ARCH_VERSION})
else()
...
if(CMAKE_CROSSCOMPILING)
  if(WIN32)
    SET(HOST_ARGS ${HOST_ARGS} -malign-double -DLUAJIT_OS=LUAJIT_OS_WINDOWS)
  elseif(IOS)
    set(HOST_ARGS ${HOST_ARGS} -arch i386 -DLUAJIT_OS=LUAJIT_OS_OSX)
  elseif(ANDROID)
    set(HOST_ARGS ${HOST_ARGS} -DLUAJIT_OS=LUAJIT_OS_LINUX)
  else()
    set(HOST_ARGS ${HOST_ARGS} -DLUAJIT_OS=LUAJIT_OS_OTHER)
  endif()
