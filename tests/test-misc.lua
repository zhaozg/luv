return require('lib/tap')(function (test)
  ...
  test("uv.wtf8 and utf8 conversion", function(print, p, expect, uv)
    -- default encode is utf8/wtf8
    -- "中文\0"
    local utf8 = string.char(0xe4, 0xb8, 0xad, 0xe6, 0x96, 0x87, 0x00)
    local utf16 = uv.wtf8_to_utf16(utf8)
    assert(#utf16==6, #utf8)
    assert(utf16==string.char(0x2d, 0x4e, 0x87, 0x65, 0x00, 0x00))
    assert(uv.utf16_length_as_wtf8(utf16) == 7, uv.utf16_length_as_wtf8(utf16))
